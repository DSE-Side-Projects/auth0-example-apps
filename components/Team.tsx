              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="text-lg leading-6 font-medium space-y-1">
                    <h3>Ellen Conley</h3>
                    <p className="text-orange">Developer Support Engineer</p>
                  </div>
                  <ul className="flex justify-center space-x-5">
                    <li>
                      <a
                        href="https://www.linkedin.com/in/ellenconley/"
            ...
            <li>
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="text-lg leading-6 font-medium space-y-1">
                    <h3>Art Rosnovsky</h3>
                    <p className="text-orange">Developer Support Engineer II</p>
                  </div>
                  <ul className="flex justify-center space-x-5">
                    <li>
                      <a
